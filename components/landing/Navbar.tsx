...
export const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-base-content/5 bg-base-100 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center justify-center absolute left-1/2 -translate-x-1/2">
          <div className="flex items-center gap-1 bg-base-200 p-1 rounded-xl border border-base-content/[0.06]">
...
const NavLink = ({ href, children }: { href: string; children: React.ReactNode }) => {
  ...
  return (
    <Link href={href} onClick={handleClick} className="group relative px-4 py-2 rounded-lg">
      ...
      <span className="absolute left-0 top-1/2 -translate-y-1/2 w-[2px] h-0 bg-blue-600 rounded-full group-hover:h-4 transition-all duration-200" />
