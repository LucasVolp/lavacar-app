...
export function CheckoutLayout({ children }: CheckoutLayoutProps) {
    return (
        <div className="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300">
